...
public class PropietarioController {
	...
	public String irPaginaListadoPropietarios(Map<String, Object> model) {
		...
		return "listPropietarios"; // "listDueno" es una pagina del frontEnd para listar
	}

	@RequestMapping("/irRegistrar")
	public String irPaginaRegistrar(Model model) {
		model.addAttribute("propietario", new Propietario());
		return "propietario"; // "dueno" es una pagina del frontEnd para insertar y/o modificar
	}
	...
	public String listar(Map<String, Object> model ) {
		model.put("listaDPropietarios", rService.listar());
